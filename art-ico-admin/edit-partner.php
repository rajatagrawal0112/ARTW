<?php include('header.php');?>
  ...
  <div class="heading-row mb-20">
    <div class="row align-item-center">
       <div class="col-lg-6">
          <h3 class="page-title"><span class="page-title-icon bg-gradient-primary text-white mr-2"><i class="mdi mdi-account-multiple"></i></span> Edit Partner </h3>
       </div>
        <div class="col-lg-6">
         <div class="text-right">
           <div>
             <a href="partner-list.php" class="btn btn-common bg-gradient-primary">Go Back</a>
           </div>
         </div>
       </div>
  </div>
                      ...
                      <div class="row">
                        <div class="col-md-4">
                             <div class="form-group">
                                <label>Partner Logo Image(Size in Pixel 210*65)</label>
                                <p class="note"></p>
                        ...
                        <div class="col-md-8">
                            <div class="row">
                              <div class="col-md-12">
                                 <div class="form-group">
                                    <label>Tittle</label>
                                    <input type="text" class="form-control" value="ENSEK">
                                  </div>
                              </div>
                                <div class="col-md-12">
                                 <div class="form-group">
                                    <label>URL</label>
                                    <input type="text" class="form-control" value="https://ensek.co.uk/">
                                  </div>
                              </div> 
                              <div class="col-md-12">
                                <div class="form-group">
