<?php include('header.php');?>
  ...
  <div class="heading-row mb-20">
    <div class="row align-item-center">
       <div class="col-lg-6">
          <h3 class="page-title"><span class="page-title-icon bg-gradient-primary text-white mr-2"><i class="mdi mdi-file-document"></i></span> Edit Document </h3>
       </div>
        <div class="col-lg-6">
         <div class="text-right">
           <div>
             <a href="upload-doc-list.php" class="btn btn-common bg-gradient-primary">Go Back</a>
           </div>
         </div>
       </div>
  </div>
                            ...
                            <div class="row">
                              ...
                              <div class="col-md-12">
                                 <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="One Pager">
                                  </div>
                              </div>
