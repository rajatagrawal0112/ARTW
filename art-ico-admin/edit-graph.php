...
<div class="heading-row mb-20">
    <div class="row align-item-center">
       <div class="col-lg-6">
          <h3 class="page-title"><span class="page-title-icon bg-gradient-primary text-white mr-2"><i class="mdi mdi-file-image"></i></span> Edit Graph Image </h3>
       </div>
       <div class="col-lg-6">
         <div class="text-right">
           <div>
             <a href="graph-img.php" class="btn btn-common bg-gradient-primary">Go Back</a>
           </div>
         </div>
       </div>
  </div>
                      ...
                      <div class="row">
                        <div class="col-md-4">
                             <div class="form-group">
                                <label>Graph Image(Size in Pixel 1415*960)</label>
                                <p class="note"></p>
                              ...
                              <div class="form-group">
                                    <label>Graph Image Tittle</label>
