<?php include('header.php');?>
  ...
  <div class="heading-row mb-20">
    <div class="row align-item-center">
       <div class="col-lg-6">
          <h3 class="page-title"><span class="page-title-icon bg-gradient-primary text-white mr-2"><i class="mdi mdi-home"></i></span> Basic Details </h3>
       </div>
        <div class="col-lg-6">
                      ...
                      <div class="row">
                        <div class="col-md-12">
                            <div class="row">
                              ...
                              <div class="col-md-4">
                                 <div class="form-group">
                                    <label>Update Social media links</label>
                                    <input type="text" class="form-control">
                                  </div>
                              </div>
                              <div class="col-md-4">
                              ...
                              <div class="col-md-4">
                                 <div class="form-group">
                                    <label>Footnote of copyrights</label>
                                    <input type="text" class="form-control">
                                  </div>
                              </div>
                              <div class="col-md-4">
