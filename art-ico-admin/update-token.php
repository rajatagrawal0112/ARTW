<?php include('header.php');?>
  ...
  <div class="heading-row mb-20">
    <div class="row align-item-center">
       <div class="col-lg-6">
          <h3 class="page-title"><span class="page-title-icon bg-gradient-primary text-white mr-2"><i class="mdi mdi-cash"></i></span> Update Token </h3>
       </div>
        <div class="col-lg-6">
                            ...
                            <div class="row">
                              ...
                              <div class="col-md-4">
                                 <div class="form-group">
                                  ...
                                  <input type="text" class="form-control" readonly="" placeholder="Enter Quantity">
                                </div>
                              </div>
                              <div class="col-md-4">
                                 <div class="form-group">
                                  <label>Ether Value</label>
                                  <input type="text" class="form-control" readonly="" placeholder="Ether Value">
                                </div>
                              </div>
                              <div class="col-md-4">
                                 <div class="form-group">
                                  <label>Btc Value</label>
                                  <input type="text" class="form-control" readonly="" placeholder="Btc Value">
                                </div>
                              </div>
                              <div class="col-md-4">
                                 <div class="form-group">
                                  <label>USD</label>
                                  <input type="text" class="form-control" readonly="" placeholder="USD">
                                </div>
                              </div>
                              <div class="col-md-4">
                                 <div class="form-group">
                                  <label>Remaining</label>
                                  <input type="text" class="form-control" readonly="" placeholder="Remaining">
                                </div>
                              </div>
